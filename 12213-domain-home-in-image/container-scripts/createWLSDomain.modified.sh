...
# Create domain
#wlst.sh -skipWLSModuleScanning -loadProperties ${DOMAIN_PROPERTIES_FILE} -loadProperties ${SEC_PROPERTIES_FILE}  /u01/oracle/custom-configs/create-wls-domain.modified.py
wlst.sh -skipWLSModuleScanning /u01/oracle/custom-configs/create-wls-domain.modified.py