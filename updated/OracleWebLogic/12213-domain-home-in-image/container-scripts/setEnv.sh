...
set_env_arg DS_NAME ${PROPERTIES_FILE}
set_env_arg DS_JNDI_NAME ${PROPERTIES_FILE}
set_env_arg DS_DRIVER ${PROPERTIES_FILE}
set_env_arg DS_USER_NAME ${PROPERTIES_FILE}
set_env_arg DS_PASSWORD ${PROPERTIES_FILE}
set_env_arg DS_DB_NAME ${PROPERTIES_FILE}
set_env_arg DS_URL ${PROPERTIES_FILE}
set_env_arg DS_INITIAL_CAPACITY ${PROPERTIES_FILE}
